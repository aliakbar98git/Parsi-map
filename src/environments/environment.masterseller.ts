const domain: string = 'master.giseller.ir'
...
export const environment = {
  ...
  cdnUrl: `https://cdn.master.goldiranplus.ir/images`,
  redisPrefix: 'MasterSeller-',
  redisPort: 6379,
  ...
  redisCacheProduct: 2,
  logServer: 'http://services.master.goldiranplus.ir:5341',
